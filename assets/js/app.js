document.addEventListener( 'DOMContentLoaded', () => {
    const squares = document.querySelectorAll( '.game__grid div' )
    ...
    const btnsMobile = document.querySelectorAll( '.game__btn-mobile' )
    const width = 10
    let currentIndex = 0
    let appleIndex = 0
    ...
    //assign functions to mobile
    btnsMobile.forEach( ( btn, i ) => {
